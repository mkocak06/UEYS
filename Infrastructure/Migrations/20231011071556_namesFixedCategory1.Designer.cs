...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231011071556_namesFixedCategory1")]
    partial class namesFixedCategory1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.AuditCommittee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Entities.Decision", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("AvaibilityStatusType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Form", b =>
                {
                    ...
                    b.Property<long>("AuthorityCategoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AuthorityCategoryId");
            ...
            modelBuilder.Entity("Core.Entities.MinRequirement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("MinRequirements");
                });

            modelBuilder.Entity("Core.Entities.MinRequirementForm", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("MinRequirementId")
                        .HasColumnType("bigint");

                    b.Property<int>("RequirementStatusType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.StandardCategory", b =>
                {
                    ...
                    b.Property<string>("StandartCategory")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Entities.Form", b =>
                {
                    b.HasOne("Core.Entities.AuthorizationCategory", "AuthorizationCategory")
                        .WithMany("Forms")
                        .HasForeignKey("AuthorityCategoryId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.MinRequirementForm", b =>
                {
                    b.HasOne("Core.Entities.Form", "Form")
                        .WithMany("MinRequirementForms")
                        .HasForeignKey("FormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.MinRequirement", "MinRequirement")
                        .WithMany("MinRequirementForms")
            ...
            modelBuilder.Entity("Core.Entities.Form", b =>
                {
                    b.Navigation("AuditCommittees");

                    b.Navigation("Decisions");

                    b.Navigation("MinRequirementForms");
                });
