    ...
    var Plugin = {
        ...
        updateSticky: function() {
            ...
            if (KTUtil.hasClass(body, 'card-sticky-on')) {
                ...
                KTUtil.css(the.header, 'top', top+70 + 'px');
        ...
        var Plugin = {
            ...
            getData: function() {
                ...
                return $.ajax(ajaxParams).done(function(response, textStatus, jqXHR) {
                    ...
                    var sanitizedDataSet = datatable.dataSet;
                    // sanitize using DOMPurify if installed
                    if (typeof DOMPurify !== 'undefined') {
                        sanitizedDataSet = DOMPurify.sanitize(datatable.dataSet);
                    }
                    $(datatable).trigger(pfx + 'datatable-on-ajax-done', [sanitizedDataSet]);
