...
namespace UI.Pages.Student.Students.StudentDetail.Tabs.StudentPerfections
{
    partial class Perfections
    {
        ...
        private void OnAddStudentPerfectionModal(PerfectionResponseDTO perfection)
        {
            ...
            //}
            _newProgram = null;
            _studentPerfection.PrintJson("1");
            _studentPerfection = new StudentPerfectionResponseDTO()
            {
            ...
            _studentPerfection.PrintJson("2");
        }

        private async void OnChangeBeginDate(DateTime? e)
        {
            _studentPerfection.ProcessDate = e;
            StateHasChanged();
        }
        ...
        {
            var result = await EducatorProgramService.GetListByProgramId(_studentPerfection.ProgramId.Value);
