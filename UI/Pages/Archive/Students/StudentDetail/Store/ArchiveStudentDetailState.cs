...
{
    public record ArchiveStudentDetailState
    {
    ...
    public class StudentDetailFeature : Feature<ArchiveStudentDetailState>
    {
        public override string GetName() => "ArchiveStudentDetail";
        protected override ArchiveStudentDetailState GetInitialState()
        {
            return new ArchiveStudentDetailState
			{
                StudentLoaded = false,
