...
namespace UI.Pages.Management.Titles
{
    ...
    public partial class Titles
    {
        ...
        private List<TitleResponseDTO> _titles;
        private PaginationModel<TitleResponseDTO> _paginationModel;
        ...
        private async Task GetTitles()
        {
            ...
            _paginationModel = await TitleService.GetPaginateList(_filter);
            if (_paginationModel.Items != null)
            {
                _titles = _paginationModel.Items;
                StateHasChanged();
            }
            else
            {
        ...
        private async Task OnDeleteHandler(TitleResponseDTO title)
        {
            ...
            if (confirm)
            {
                try
                {
                    await TitleService.Delete((long)title.Id);
