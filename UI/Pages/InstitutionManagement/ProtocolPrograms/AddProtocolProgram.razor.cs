...
public partial class AddProtocolProgram
{
        ...
        _links = new List<BreadCrumbLink>()
        {
            new BreadCrumbLink()
                ...
                },new BreadCrumbLink()
                {
                    ...
                    IsActive = false,
                    OrderIndex = 2,
                    Title = @L["add_new", L["Protocol Program"]]
                }
        };
        base.OnInitialized();
    }
    ...
    private async Task Save()
    {
        ...
        _saving = true;
        StateHasChanged();
        _protocolProgram.Type = ProgramType.Protocol;
        ...
        try
        {
            ...
            if (response.Result)
            {
                ...
                NavigationManager.NavigateTo($"./institution-management/protocol-programs/{response.Item.Id}");
            }
            else
            {
