...
using UI.Services;
namespace UI.Pages.InstitutionManagement.Curriculum.CurriculumDetail
{
    public partial class CurriculumDetail
    {
        ...
        private CurriculumResponseDTO SelectedCurriculum => CurriculumDetailState.Value.Curriculum;
