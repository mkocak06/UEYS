...
using Rectangle = UI.SharedComponents.BlazorLeaflet.Models.Rectangle;

namespace UI.SharedComponents.BlazorLeaflet
{
    public static class LeafletInterops
    {
        ...
        public static ValueTask Destroy(IJSRuntime jsRuntime, string mapId) =>
            jsRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.destroy", mapId);
        ...
        public static ValueTask SetMapOnModal(IJSRuntime jsRuntime, string mapId, Guid modalId) =>
            jsRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setMapOnModal", mapId, modalId);
    }
}
