...
namespace UI.SharedComponents.BlazorLeaflet.Models
{
    public class Marker : InteractiveLayer
    {
        ...
        public async Task<JsonElement> getLatLng(IJSRuntime jsRuntime, string mapId)
        {
            return await jsRuntime.InvokeAsync<JsonElement>("leafletBlazor.getLatLng", mapId, Id);
        }
