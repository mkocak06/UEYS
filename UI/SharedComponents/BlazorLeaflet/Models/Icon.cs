...
namespace UI.SharedComponents.BlazorLeaflet.Models
{
    public class Icon
    {
        ...
        public Icon(MarkerType markerType)
        {
            Url = "src/media/map/markers/" + markerType.GetDescription() + ".png";
            ShadowUrl = "/src/media/map/markers/marker-shadow.png";
            Width = 25;
            Height = 41;
            //Size = new Size(25,41);
